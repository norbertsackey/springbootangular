package org.bezkoder.controller;
...
import org.bezkoder.model.Tutorial;
import org.bezkoder.repository.TutorialRepository;
	...
	public ResponseEntity<List<Tutorial>> getAllTutorials(@RequestParam(required = false) String title) {
		try {
			...
			if (tutorials.isEmpty()) {
				logger.log(Level.DEBUG, "No content was returned");
